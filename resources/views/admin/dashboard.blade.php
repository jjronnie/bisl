<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
        ...
        <x-stat-card title="Total Savings" value="UGX {{ number_format($totalBalance) }}" icon="banknote" />
        <x-stat-card title="Total Loans" value="150" icon="users" />
        <x-stat-card title="Total Members" value="150" icon="users" />
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4"><span
                                class="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800">Deposit</span></td>
                        <td class="px-6 py-4 font-semibold text-green-600">KES 5,000</td>
                        <td class="px-6 py-4 text-gray-600">2025-10-15</td>
                        <td class="px-6 py-4"><span
                                class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">Completed</span></td>
                    </tr>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">Jane Smith</td>
                        <td class="px-6 py-4"><span
                                class="px-2 py-1 text-xs rounded-full bg-orange-100 text-orange-800">Loan</span></td>
                        <td class="px-6 py-4 font-semibold text-orange-600">KES 50,000</td>
                        <td class="px-6 py-4 text-gray-600">2025-10-14</td>
                        <td class="px-6 py-4"><span
                                class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">Approved</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
