<x-app-layout>
    <x-page-title title="Create Payroll Grade" subtitle="Add a new salary grade" />
        ...
        <form method="POST" action="{{ route('admin.payroll.grades.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <x-required-mark />
                    <x-text-input id="monthly_basic_salary" name="monthly_basic_salary" type="number" step="0.01" class="mt-1 block w-full" :value="old('monthly_basic_salary')" required />
                ...
                <div>
                    ...
                    <x-required-mark />
                    <x-text-input id="working_days_divisor" name="working_days_divisor" type="number" class="mt-1 block w-full" :value="old('working_days_divisor', 30)" required />
            ...
            <div class="flex items-center justify-end space-x-3 mt-6">
                ...
                <x-primary-button>Create Grade</x-primary-button>
            </div>
        </form>
    </div>
</x-app-layout>
